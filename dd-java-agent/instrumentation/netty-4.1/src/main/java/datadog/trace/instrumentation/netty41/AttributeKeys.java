...
public class AttributeKeys {
  ...
  private static final Callable<ConcurrentMap<String, AttributeKey<?>>> mapSupplier =
      new Callable<ConcurrentMap<String, AttributeKey<?>>>() {
        @Override
        public ConcurrentMap<String, AttributeKey<?>> call() {
